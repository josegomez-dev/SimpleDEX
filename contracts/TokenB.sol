...
/// @title TokenB - Basic ERC-20 Token for DEX Testing
/// @notice TokenB is the second trading asset in a simple decentralized exchange
/// @dev Implements a minimal version of the ERC-20 standard for compatibility
contract TokenB {
    string public constant name = "TokenB";           // Token name
    string public constant symbol = "TKB";            // Token symbol
